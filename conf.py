...
BLOG_AUTHOR = "Perhaps Author"  # (translatable)
BLOG_TITLE = "Perhaps Value"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://perhaps-value.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://perhaps-value.github.io/"
BLOG_EMAIL = "spam@perhaps-value.local"
BLOG_DESCRIPTION = "Perhaps."  # (translatable)
...
GLOBAL_CONTEXT = {
        'TWITTER_URL': None,
        'GITHUB_URL': 'https://github.com/perhaps-value/',
        'LINKEDIN_URL': None,
